...
class StringClassToITest < Test::Unit::TestCase
  ...
  def test_string_to_i_should_return_a_well_formated_float
    assert_equal @reference_integer, @localized_number_en.to_i
    I18n.locale = :'pt-br'
    assert_equal @reference_integer, @localized_number_pt_br.to_i
  end
