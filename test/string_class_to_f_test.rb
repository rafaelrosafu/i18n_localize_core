...
class StringClassToFTest < Test::Unit::TestCase
  ...
  def test_string_to_f_should_return_a_well_formated_float
    assert_equal @reference_number, @localized_number_en.to_f
    I18n.locale = :'pt-br'
    assert_equal @reference_number, @localized_number_pt_br.to_f
  end
  ...
  def test_string_to_f_should_return_a_bizarre_float_when_receiving_the_wrong_format
    assert_equal @bizarre_number, @localized_number_pt_br.to_f
    I18n.locale = :'pt-br'
    assert_equal @bizarre_number, @localized_number_en.to_f
  end
